...
class RoastersTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		$roaster = new Roaster();
                ...
                $roaster->url           = 'woodburlcoffee.com';
                ...
                $roaster->twitter       = 'search?q=press%20coffee%20dayton&src=typd';
                $roaster->facebook      = 'PressCoffeeBarDYT?fref=ts';
                $roaster->instagram     = 'woodburlcoffee/';
                $roaster->save();
                ...
                $roaster->twitter       = 'CorvusCoffee';
                $roaster->facebook      = 'CorvusCoffeeRoasters?fref=ts';
                $roaster->instagram     = 'corvuscoffee/';
                $roaster->save();
                ...
                $roaster->twitter       = 'OnyxCoffeeLab';
                $roaster->facebook      = 'OnyxCoffeeLab/';
                $roaster->instagram     = 'onyxcoffeelab/';
                $roaster->save();
                ...
                $roaster->url           = 'counterculturecoffee.com';
                ...
                $roaster->twitter       = 'counter_culture';
                $roaster->facebook      = 'counterculturecoffee';
                $roaster->instagram     = 'counterculturecoffee/';
                $roaster->save();
                ...
                $roaster->twitter       = 'metriccoffee';
                $roaster->facebook      = 'metriccoffee';
                $roaster->instagram     = 'metriccoffee';
                $roaster->save();
	}
}