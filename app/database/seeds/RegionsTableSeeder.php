...
class RegionsTableSeeder extends Seeder {
	...
	public function run()
	{
        ...
        $region->img_url        = 'https://maps.googleapis.com/maps/api/staticmap?center=ethiopia&zoom=5&size=400x400&maptype=roadmap&key=AIzaSyDAySxaq2FF-SkNhPq14sng77oo0ay_DiY';
        $region->save();
...
In general, this is a bright coffee that lights up the palate from front to back. It is not for people who do not like acidity in coffee (acidity being the prized bright notes in the cup due to an interrelated set of chlorogenic acids). A great Kenya is complex, and has interesting fruit (berry, citrus) flavors, sometimes alternating with spice. Some are clean and bright, others have cherished winey flavors. - Sweet Maria\'s';
        $region->img_url        = 'https://maps.googleapis.com/maps/api/staticmap?center=kenya&zoom=5&size=400x400&maptype=roadmap&key=AIzaSyDAySxaq2FF-SkNhPq14sng77oo0ay_DiY';
        $region->save();
        ...
        $region->img_url        = 'https://maps.googleapis.com/maps/api/staticmap?center=elsalvador&zoom=7&size=400x400&maptype=roadmap&key=AIzaSyDAySxaq2FF-SkNhPq14sng77oo0ay_DiY';
        $region->save();
        ...
        $region->img_url        = 'https://maps.googleapis.com/maps/api/staticmap?center=costarica&zoom=6&size=400x400&maptype=roadmap&key=AIzaSyDAySxaq2FF-SkNhPq14sng77oo0ay_DiY';
        $region->save();
        ...
        $region->img_url        = 'https://maps.googleapis.com/maps/api/staticmap?center=sumatra&zoom=5&size=400x400&maptype=roadmap&key=AIzaSyDAySxaq2FF-SkNhPq14sng77oo0ay_DiY';
        $region->save();
        ...
        $region->img_url        = 'https://maps.googleapis.com/maps/api/staticmap?center=colombia&zoom=5&size=400x400&maptype=roadmap&key=AIzaSyDAySxaq2FF-SkNhPq14sng77oo0ay_DiY';
        $region->save();
        ...
        $region->img_url        = 'https://maps.googleapis.com/maps/api/staticmap?center=guatemala&zoom=6&size=400x400&maptype=roadmap&key=AIzaSyDAySxaq2FF-SkNhPq14sng77oo0ay_DiY';
        $region->save();

        $region = new Region();
        $region->name           = 'Blend';
        $region->description    = 'Sometimes people enjoy drinking blends. Who am I to say that\'s wrong?';
        $region->img_url        = '/img/blend.jpg';
        $region->save();
