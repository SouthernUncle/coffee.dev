...
class CoffeesTableSeeder extends Seeder {
	...
	public function run()
	{
        ...
        $coffee->url_name               = 'WoodBurl-SukeQuto';
        $coffee->save();
        ...
        $coffee->url_name               = 'WoodBurl-KiiAa';
        $coffee->save();
        ...
        $coffee->url_name               = 'Onyx-Similakuta';
        $coffee->save();
        ...
        $coffee->url_name               = 'Onyx-SanAntonio';
        $coffee->save();
        ...
        $coffee->url_name               = 'CounterCulture-LaVoz';
        $coffee->save();
        ...
        $coffee->url_name               = 'CounterCulture-Idido';
        $coffee->save();
        ...
        $coffee->url_name               = 'Metric-SantaElena';
        $coffee->save();
