...
class CoffeesTableSeeder extends Seeder {
	...
	public function run()
	{
     ...
     //    $coffee->save();
        ...
        // To test pagination and ratings sorting
        $coffee = new Coffee();
        $coffee->user_id                = 1;
        $coffee->region_id              = 1;
        $coffee->roaster_id             = 1;
