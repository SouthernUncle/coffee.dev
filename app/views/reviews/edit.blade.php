...
@section('content')
	<div class="container">
		<div class ="col-xs-12 center-it">
			<!-- HEADER -->
			<h1 class="brown">{{ $review->coffee->name }}</h1>
			<span class="fancy brown small"> - by - </span>
			<h2 class="fancy brown">{{ $review->coffee->roaster->name }}</h2>
			<hr>
		</div>
	{{ Form::model($review, array('action' =>array('ReviewsController@update', $review->id), 'method' =>'PUT')) }}
        ...
        <!-- REVIEW TEXT -->
        <div class="col-xs-12 full center-it">
        	<span class="slider-title fancy center-it">Review</span>
